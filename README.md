...
See the full [installation instructions](https://k6.io/docs/get-started/installation/) for more information.

Additionally, we also have available [guides for installing k6 in specific CI tools](https://k6.io/docs/integrations/#continuous-integration-and-continuous-delivery).
...
* [Website testing guide](https://k6.io/docs/testing-guides/load-testing-websites/)
* [API testing guide](https://k6.io/docs/testing-guides/api-load-testing/)
...
# 3. Create a test
Every step in an automation pipeline either passes or fails. As mentioned in Know your goals, the mechanism by which k6 decides whether a test has passed or failed is called [thresholds](https://k6.io/docs/using-k6/thresholds/). Without your goals codified as thresholds there's no way for k6 to actually know if your test should be considered a success or failure.
...
```
Get your k6 Cloud token from the [account settings page](https://app.k6.io/account/login).
...
A quick re-cap of the test [life cycle](https://k6.io/docs/using-k6/test-lifecycle/) article:
...
For Slack you need to first [setup an incoming webhook.](https://slack.com/intl/pt-br/help/articles/115005265063-Webhooks-de-entrada-para-o-Slack) Once setup you get a webhook URL that you specify as the target of the POST request in the teardown function:
